        ...
        '
          ...
          >
            ...
            '
                ...
                onClick={() => handleEdit(props.authorsId)}
              >
            ...
            <li>
              ...
              ease-in-out
            '
                tabIndex={props.authorsId}
                data-bs-toggle='modal'
                data-bs-target={`#exampleModal${props.authorsId}`}
                to='#'
              >
          ...
          <DeleteModals
            exampleModal={`exampleModal${props.authorsId}`}
            authorId={props.authorsId}
          />
        </div>
      </div>
    </div>
