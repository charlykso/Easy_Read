    ...
    return (
      <div className='right bg-gray-200 h-full pt-5 w-2/5 rounded-lg '>
        ...
        >
          ...
          natus laboriosam. Lorem ipsum dolor sit amet consectetur adipisicing
          elit. Nam facilis eligendi quo voluptatem incidunt minima, impedit
          assumenda commodi nobis consequatur, aspernatur non? Veritatis,
          provident quisquam beatae ipsam iure dolor dolorum.
        </p>
      </div>
    )
}
